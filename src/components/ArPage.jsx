...
export default function ArPage() {
  ...
  if (screen === 'avatar-complete') return <AvatarCompletePage language={language} avatarImage={completedAvatar} onFinish={() => setScreen('intro')} />;
