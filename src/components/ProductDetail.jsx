    ...
    <div className="product-page" id="top">
      ...
      <main>
        <section className="product" aria-label="상품 상세">
          ...
          <div className="details">
            ...
            <div className="colors">
              <p>컬러 <strong>{selectedColour.name}</strong></p>

              <div className="swatches" role="group" aria-label="색상 선택">
            ...
            <button className="cart-button" type="button">장바구니 담기</button>
        ...
        <section className="recommendations" aria-labelledby="recommend-title">
          <h2 id="recommend-title">함께 보면 좋은 상품</h2>
